...
#block(width: 100%)[
  ...
  #table(
    ...
    [`UCAL-E0016`], [no such entry in a declared catalogue], [6], [12],
    [`UCAL-E0017`], [data file cannot be read or is not well-formed], [6], [12],
    [`UCAL-E0018`], [value not accepted for this option or field], [2], [12],
    [`UCAL-E0019`], [internal invariant violated; this is a defect in ucal], [9], [12],
